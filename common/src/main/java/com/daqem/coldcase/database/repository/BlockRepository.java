...
public class BlockRepository extends Repository {
    ...
    private <T extends BlockHistory> List<IHistory> getBlockHistory(String levelName, int x, int y, int z, BlockHistoryFactory factory) {
        ...
        try (PreparedStatement preparedStatement = database.prepareStatement(query)) {
            ...
            com.daqem.coldcase.ColdCase.LOGGER.error("Failed to get block history", e);
        }
        return blockHistory;
    }
    ...
    public void removeInteractionsForPosition(String levelName, int x, int y, int z) {
        ...
        try {
            ...
            com.daqem.coldcase.ColdCase.LOGGER.error("Failed to remove interactions for position", e);
        }
    }
