...
public class UserRepository extends Repository {
    ...
    public void insertOrUpdateName(String name, String uuid) {
        ...
        try {
            ...
            com.daqem.coldcase.ColdCase.LOGGER.error("Failed to insert username into database", exception);
        }
    }
    ...
    public Map<Integer, String> getAllUsernames() {
        ...
        try (PreparedStatement preparedStatement = database.prepareStatement(query)) {
            ...
            com.daqem.coldcase.ColdCase.LOGGER.error("Failed to get all usernames from database", exception);
        }
        return usernames;
    }
}
